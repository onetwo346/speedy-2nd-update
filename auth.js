...
// Pulls the shared driver list down from the backend and merges it into
// localStorage. Call (and await) this before reading drivers on a device
// that may not have signed the driver up locally — e.g. before login,
// or before checking approval status.
const speedySyncDriversNow = async () => {
